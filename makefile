...
CXX=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/arm-linux-androideabi-4.8/bin/arm-linux-androideabi-clang++ --sysroot=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/arm-linux-androideabi-4.8/sysroot

CC=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/arm-linux-androideabi-4.8/bin/arm-linux-androideabi-clang --sysroot=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/arm-linux-androideabi-4.8/sysroot
# A C++ compiler, e.g., g++, CC, xlC

# Newly added by Allan
PHONE_TMP_DIR=/data/local/tmp
TARGET_ARCH_ABI=armeabi-v7a	#armeabi-v7a for v7 arm, armeabi for greater compatability
LIBTOOL=libtool
SYSROOT=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/arm-linux-androideabi-4.8/sysroot

# Flags for the C++ compiler
CXXFLAGS=-g -O2
CXXAUTOFLAGS=-march=armv7-a
# Flags for the C++ compiler, automatically generated by configuration script


AR=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/arm-linux-androideabi-4.8/bin/arm-linux-androideabi-ar
# command to make a library

ARFLAGS=ruv
# arguments for AR

RANLIB=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/arm-linux-androideabi-4.8/bin/arm-linux-androideabi-ranlib
# set to echo if you want to disable it completely

LDFLAGS=
# libraries for linking C++ programs

LDLIBS=-lstdc++ -latomic
# libraries for linking C++ programs
...
DEF_PREFIX=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/gmp

PREFIX=/home/allan/Desktop/new_builds/ntl/ntl-9.6.4/src/build
LIBDIR=$(PREFIX)/lib
...
CFLAGS= -I$(SYSROOT)/usr/include -fpic -mthumb-interwork -ffunction-sections -funwind-tables -fstack-protector -fno-short-enums -fomit-frame-pointer \
...
# Added for running the setup scripts
COMPILE_CXX_p1 = $(CXX)
COMPILE_CXX_p2 = $(NTL_INCLUDE) \
    -nostdlib -Bdynamic \
    -Wl,-dynamic-linker,/system/bin/linker \
    -Wl,--gc-sections \
    -Wl,-z,nocopyreloc \
...
setup1:
	$(COMPILE_CXX) MakeDescAux.c
	#$(LINK_CXX) -o MakeDesc MakeDesc.c MakeDescAux.o
	# Alternate to above line ############################
	$(LINK_CXX_P1) MakeDesc.c MakeDescAux.o $(LINK_CXX_P2) -o MakeDesc
	######################################################
...
setup2:
	sh MakeGetTime "$(LINK_CXX_P1)" "$(LINK_CXX_P2)" "$(PHONE_TMP_DIR)"
	sh MakeGetPID  "$(LINK_CXX_P1)" "$(LINK_CXX_P2)" "$(PHONE_TMP_DIR)"
	sh MakeCheckFeature BUILTIN_CLZL "CheckCLZL.c CheckCLZLAux.c" "$(LINK_CXX_P1)" "$(LINK_CXX_P2)" "$(PHONE_TMP_DIR)"
	sh MakeCheckFeature LL_TYPE "CheckLL.c CheckLLAux.c" "$(LINK_CXX_P1)" "$(LINK_CXX_P2)" "$(PHONE_TMP_DIR)"
	sh MakeCheckFeature AVX "CheckAVX.c" "$(LINK_CXX_P1)" "$(LINK_CXX_P2)" "$(PHONE_TMP_DIR)"
	sh MakeCheckFeature FMA "CheckFMA.c" "$(LINK_CXX_P1)" "$(LINK_CXX_P2)" "$(PHONE_TMP_DIR)"
...
setup3:
	$(LINK_CXX_P1) gen_gmp_aux.c $(LINK_CXX_P2) $(GMP_OPT_INCDIR) -o gen_gmp_aux $(GMP_OPT_LIBDIR) $(GMP_OPT_LIB)
...
lip.o:	lip.c g_lip_impl.h c_lip_impl.h 
	$(LCOMP) $(COMPILE_CXX_p1) lip.c $(COMPILE_CXX_p2) $(GMP_OPT_INCDIR)

ctools.o:	ctools.c
	$(LCOMP) $(COMPILE_CXX_p1) ctools.c $(COMPILE_CXX_p2)


GetTime.o: GetTime.c 
	$(LCOMP) $(COMPILE_CXX_p1) GetTime.c $(COMPILE_CXX_p2)

GetPID.o: GetPID.c 
	$(LCOMP) $(COMPILE_CXX_p1) GetPID.c $(COMPILE_CXX_p2)

CheckCompile: CheckCompile.c
	$(LINK_CXX_P1) CheckCompile.c $(LINK_CXX_P2) -o CheckCompile $(LDLIBS)


.c.o: 
	$(LCOMP) $(COMPILE_CXX_p1) $< $(COMPILE_CXX_p2) $(GF2X_OPT_INCDIR) 

.c: 
	$(LINK_CXX_P1) $< $(LINK_CXX_P2) -o $@ ntl.a $(GMP_OPT_LIBDIR) $(GMP_OPT_LIB) $(GF2X_OPT_LIBDIR) $(GF2X_OPT_LIB) $(LDLIBS) #LSTAT
